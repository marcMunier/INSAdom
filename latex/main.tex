...
Nous avons aussi utilisé, l'interface web proposée par Z-Wave afin de générer des scénarios en respectant des conditions (If ---> Then). Avec cet outil, nous avons pu générer plusieurs scénarios. Des vidéos de démonstration se trouvent dans ces liens.\newline
% Liens de vidéos youtube de démo si possible
Dans l'interface Web proposée par Zwave, un fichier de log existe permettant à l'utilisateur de pouvoir visualiser tout ce qui se passe pendant la journée concernant les capteurs.
