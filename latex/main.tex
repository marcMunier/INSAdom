...
\begin{figure}[h]
	\center
\includegraphics[scale=0.4]{./Images/png/manage_zwaveme.png}
...
\begin{figure}[h]
	\center
	\includegraphics[scale=0.4]{./Images/png/delete_zwaveme.png}
...
\begin{figure}[h]
	\center
	\includegraphics[scale=0.4]{./Images/png/exclusion_zwaveme.png}
...
\begin{figure}[h]
	\center
\includegraphics[scale=0.4]{./Images/png/devices_exclu_zwaveme.png}
	\caption{ZwaveMe exclusion capteur}
\end{figure}
\clearpage
...
\begin{figure}[h]
	\center
\includegraphics[scale=0.4]{./Images/png/app_zwaveme.png} 
...
\begin{figure}[h]
	\center
\includegraphics[scale=0.4]{./Images/png/device_Status.png}
